            ...
            <div class="well bs-component col-md-8 col-md-offset-2">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <asp:TextBox ID="FirstName" BackColor="Wheat" runat="server" />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label runat="server" Text="Last Name" class="col-lg-2 control-label" />
                        <div class="col-lg-10">
                            <asp:TextBox ID="LastName" BackColor="Wheat" runat="server" />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label runat="server" Text="Faculty Number" class="col-lg-2 control-label" />
                        <div class="col-lg-10">
                            <asp:TextBox ID="FacultyNumber" BackColor="Wheat" runat="server" />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label runat="server" Text="University" class="col-lg-2 control-label" />
                        <div class="col-lg-10">
                            <asp:DropDownList ID="University" BackColor="Wheat" runat="server" SelectMethod="GetUniversities" />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label runat="server" Text="Speciality" class="col-lg-2 control-label" />
                        <div class="col-lg-10">
                            <asp:DropDownList ID="Speciality" BackColor="Wheat"  runat="server" SelectMethod="GetSpecialities" />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label runat="server" Text="Courses" class="col-lg-2 control-label" />
                        <div class="col-lg-10">
                            <asp:CheckBoxList ID="Courses" BackColor="Wheat" runat="server" SelectMethod="GetCourses" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-10">
