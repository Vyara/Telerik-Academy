<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeDetails.aspx.cs" Inherits="EmployessGridView.EmployeeDetails" %>
...
<body>
    <form id="formMain" runat="server">
        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-success" OnClick="LinkButtonRedirect_Click">Return</asp:LinkButton>
        <div>
