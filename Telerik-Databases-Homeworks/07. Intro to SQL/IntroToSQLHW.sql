...
SELECT e.FirstName + ' ' + e.LastName AS FullName, e.JobTitle, d.Name,
...
SELECT Name AS 'Town and Department'
FROM Departments
UNION
SELECT Name AS 'Town and Department'
FROM Towns
...
SELECT e.FirstName + ' ' + e.LastName AS Employee, e.HireDate AS 'Hire Date', d.Name AS Department 
