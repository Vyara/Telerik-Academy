namespace StudentSystem.Web.Controllers
{
    ...
    public class CoursesController : ApiController
    {
        ...
        {
            return this.Ok(this.data.Courses.All().ProjectTo<CourseDataModel>());
        }

        [HttpPost]
        public IHttpActionResult Post([FromBody]CourseDataModel model)
        {
        ...
        [HttpPut]
        public IHttpActionResult Edit([FromBody]CourseDataModel model)
        {
            if (!this.ModelState.IsValid)
            {
                return this.BadRequest(this.ModelState);
        ...
        [HttpDelete]
        public IHttpActionResult Remove(string guid)
        {
