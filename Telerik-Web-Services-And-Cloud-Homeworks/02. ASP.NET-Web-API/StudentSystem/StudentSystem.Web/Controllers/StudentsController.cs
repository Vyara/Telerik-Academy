namespace StudentSystem.Web.Controllers
{
    ...
    public class StudentsController : ApiController
    {
        ...
        {
            return this.Ok(this.data.Students.All().ProjectTo<StudentDataModel>());
        }
        ...
        public IHttpActionResult Find(int id)
        {
            ...
            {
                return this.Ok(results.ProjectTo<StudentDataModel>());
            }
        }

        [HttpPost]
        public IHttpActionResult Post([FromBody] StudentDataModel model)
        {
        ...
        [HttpPut]
        public IHttpActionResult Edit(int id, [FromBody]StudentDataModel model)
        {
            if (!this.ModelState.IsValid)
            {
                return this.BadRequest(this.ModelState);
